/*
 * 文件名：_IdWorker.java 版权：Copyright by www.sdhuijin.cn 描述： 修改人：sunp@sdhuijin.cn 修改时间：2018年6月27日
 * 修改内容：
 */
...
public class _IdWorker
{
    ...
    public synchronized long nextId()
        throws Exception
    {
        long timestamp = _IdWorker.timeGen();
        ...
        {
            // logger.error(String.format("clock moved backwards.Refusing to generate id for %d
